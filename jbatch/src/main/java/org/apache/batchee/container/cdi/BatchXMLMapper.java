...
public class BatchXMLMapper {
    ...
    private static final Map<ClassLoader, ArtifactMap> LOADER_2_ARTIFACT_MAP = new WeakHashMap<ClassLoader, ArtifactMap>();

    public BatchXMLMapper(ClassLoader loader) {
        artifactMap = LOADER_2_ARTIFACT_MAP.get(loader);
        if (artifactMap == null) {
    ...
    private static synchronized ArtifactMap populateArtifactMap(ClassLoader loader) {
        ...
        ArtifactMap artifactMap = LOADER_2_ARTIFACT_MAP.get(loader);
        ...
        if (is != null) {
            ...
            LOADER_2_ARTIFACT_MAP.put(loader, artifactMap);
        } else {
            if (logger.isLoggable(Level.FINER)) {
